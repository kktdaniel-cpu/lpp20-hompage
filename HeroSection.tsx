...
const copy = {
  ko: {
    ...
    headline1: "시니어의 인생 2막을",
    headline2: "함께 설계합니다.",
    sub_en: "Senior Life Masterplan & Mossrium Solutions",
    desc: "은퇴 후 삶을 체계적으로 설계하는 AI 마스터플랜 플랫폼 '2막1장'과 Mossrium Solutions 기술로, 초고령화 시대의 새로운 삶의 방식을 만들어갑니다.",
  ...
  en: {
    ...
    headline1: "Your Senior Life,",
    headline2: "Masterplanned.",
    sub_en: "AI-Powered Senior Life Masterplan Platform",
    desc: "Life 2.0 helps seniors design a fulfilling second act — through our AI-powered life masterplan platform '2nd Act, 1st Scene' and Mossrium Solutions — our sustainable moss-based air purification and agrivoltaic technology.",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(43,72,60,0.97) 0%, rgba(43,72,60,0.60) 55%, rgba(43,72,60,0.95) 100%)",
        }}
      />
        ...
        {[33.333, 66.666].map((left, i) => (
          <div
            ...
            style={{
              left: `${left}%`,
              width: "1px",
              background: `linear-gradient(to bottom, transparent, rgba(200,169,106,${0.10 - i * 0.03}) 25%, rgba(200,169,106,${0.10 - i * 0.03}) 75%, transparent)`,
            }}
          />
        ))}
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center container pt-28 pb-16">
        <div className="max-w-4xl">
          ...
          >
            <span className="w-8 h-px bg-[var(--gold-satin)]" />
            <span className="font-en text-xs text-[var(--gold-satin)] tracking-[0.2em] uppercase font-medium">
              {t.eyebrow}
            </span>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ color: "rgba(232,217,192,0.85)" }}
            >
              {t.sub_en}
            </p>
          </div>
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((s, i) => (
              ...
              >
                <div className="font-en font-bold text-lg md:text-xl" style={{ color: "var(--gold-satin)", letterSpacing: "-0.02em" }}>
                  {s.value}
                </div>
