...
const copy = {
  ko: {
    ...
    company: "주식회사 라이프이점영",
    ceo: "대표이사 김영범",
    reg: "사업자등록번호: 710-88-03849",
    address: "경기도 고양시 덕양구 청초로 19, A동 2105호 (덕은 DMC IS비즈타워 센트럴)",
  ...
  en: {
    ...
    nav: [
      { label: "Who We Are", href: "/#who-we-are" },
      { label: "What We Do", href: "/#what-we-do" },
      { label: "2Mak1Jang", href: "/imakiljang" },
      { label: "Contact", href: "/#contact" },
    ],
    legal: [
    ...
    reg: "Business Reg. No.: 710-88-03849",
    address: "19 Cheongcho-ro, Deogyang-gu, Goyang-si, Gyeonggi-do, Korea",
    copyright: `© ${new Date().getFullYear()} Life 2.0 Corp. All rights reserved.`,
  },
};
...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "var(--avo-deep)" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 items-start mb-12">
          ...
          <div>
            <div className="flex items-baseline gap-2 mb-3">
              ...
              <span className="font-en font-bold text-xl" style={{ color: "var(--avo-mid)" }}>2.0</span>
            </div>
