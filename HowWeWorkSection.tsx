        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-16 items-start">
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-baseline gap-3 mb-2">
                        <h4 className="font-display font-bold text-base text-white group-hover:text-[var(--avo-mid)] transition-colors duration-300">
                          {p.title}
                        </h4>
          ...
          <div className="space-y-4">
            ...
            {t.culture_items.map((c) => (
              ...
              >
                <div className="font-en text-xs text-[var(--avo-mid)] tracking-wide uppercase mb-1">{c.label}</div>
              ...
              <div className="flex flex-wrap gap-2">
                {t.certs.map((c) => (
                  <span
                    ...
                    style={{ borderColor: "rgba(143,175,90,0.4)", color: "rgba(143,175,90,0.9)" }}
                  >
                    {c}
                  </span>
                ))}
            ...
            <div className="p-5" style={{ backgroundColor: "var(--avo-deep)" }}>
              <p className="font-en text-xs text-[var(--avo-mid)] tracking-widest uppercase mb-2">{t.hiring_title}</p>
