/**
 * Imakiljang (2막1장) Detail Page — Renewal v2
 * Design: "Established Authority" — Dark Navy + Forest Green + Warm Gold
 *
 * Color System (aligned with homepage):
 *   Background: #1A4731 (Deep Navy), #1A4731 (Dark Navy), #1A4731 (Forest Green)
 *   Surface: #F5F3EF (Off-White), #FFFFFF (White)
 *   Primary text: #1A4731 (on light), #F5F3EF (on dark)
 *   Gold accent: #D69E2E (Warm Gold)
...
const copy = {
  ko: {
    ...
    chapterDesc: "그 무대의 첫 장을 가장 안전하고 품격 있게 여는 시작점. 2막1장이 함께합니다.",
    ...
    ctaDesc: "현재 2막1장 플랫폼은 개발 중입니다. 파트너십, 투자 문의, 사전 등록은 아래 버튼을 통해 연락해 주세요.",
    ctaBtn1: "파트너십 문의하기",
    ctaBtn2: "홈으로 돌아가기",
  },
  en: {
...
const cores = [
  ...
  },
  {
    ...
    icon: DollarSign, color: "#D69E2E", bg: "rgba(201,168,76,0.1)",
...
const bizModels = [
  ...
  { step: "02", title: "유료 시뮬레이터", titleEn: "Premium Simulator", desc: "부동산 주택연금 시뮬레이터 등 프리미엄 진단 기능", descEn: "Premium diagnostic features including real estate housing pension simulator", icon: TrendingUp, color: "#D69E2E" },
  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] font-body">
      ...
      <div className="fixed top-0 left-0 right-0 z-[60] h-0.5 bg-white/10">
        <div
          className="h-full bg-[#D69E2E] transition-all duration-150"
      ...
      <section className="relative min-h-screen flex items-end overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1A4731]/95 via-[#1A4731]/50 to-[#1A4731]/20" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#1A4731]/70 to-transparent" />
        </div>
        ...
        <div className="absolute top-24 left-0 right-0 z-10">
          <div className="container">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-white/50 hover:text-[#D69E2E] transition-colors duration-300 text-sm font-body"
            >
              <ArrowLeft size={14} />
              {t.backLink}
            </Link>
        ...
        <div className="relative z-10 container pb-20 md:pb-28">
          <div className="max-w-3xl">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-6 h-px bg-[#D69E2E]" />
              <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">
                {t.heroLabel}
              </span>
            </div>
            ...
            <p className="font-display text-2xl md:text-3xl text-[#D69E2E] mb-2 tracking-widest">
              {t.heroHanja}
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#D69E2E] text-[#1A4731] text-sm font-semibold hover:bg-[#b8963e] transition-all duration-300"
              >
                {t.heroCta1}
                <ArrowRight size={14} />
              </a>
              ...
              <a
                href="/manus-storage/imakiljang_diagnosis_v4_92d4db12.html"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-[#1A4731] text-sm font-bold hover:bg-[#F6E05E] transition-all duration-300 shadow-lg hover:-translate-y-0.5"
              >
                {t.heroCta3}
              </a>
            </div>
      ...
      {/* ── BRAND MEANING ────────────────────────────────────────────────── */}
      <section id="service-overview" className="py-24 md:py-32 bg-[#1A4731]">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.brandLabel}</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white leading-tight mb-8">
                {t.brandTitle}<br />
                <span className="text-[#D69E2E]">{t.brandTitleAccent}</span>
              </h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-0.5 bg-[#D69E2E] flex-shrink-0" />
                  <div>
                ...
                {[
                  ...
                  <FadeUp key={i} delay={0.08 * i}>
                    <div className="p-5 border border-white/8 bg-white/4 hover:bg-white/7 transition-colors duration-300">
                      <p className="font-display text-2xl font-bold text-[#D69E2E] mb-1">{stat.num}</p>
          ...
          <FadeUp>
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.coreLabel}</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A4731] leading-tight mb-4">
                {t.coreTitle}<br />
            ...
            <FadeUp>
              <div className="relative overflow-hidden aspect-square max-w-md mx-auto md:mx-0">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1A4731]/80 to-transparent flex items-end p-6">
              ...
              {cores.map((core, i) => {
                ...
                return (
                  <FadeUp key={core.id} delay={i * 0.05}>
                    <div className="group flex items-start gap-4 p-4 border border-[#E5E0D8] hover:border-[#D69E2E]/40 bg-white hover:bg-[#FAFAF8] transition-all duration-300 cursor-default">
                      <div
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="font-display text-sm font-semibold text-[#1A4731]">{core.ko}</span>
      ...
      {/* ── SCORE FORMULA ────────────────────────────────────────────────── */}
      <section className="py-20 md:py-28 bg-[#1A4731] overflow-hidden">
        <div className="container">
          <FadeUp>
            <div className="text-center mb-14">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.formulaLabel}</span>
                <div className="w-6 h-px bg-[#D69E2E]" />
              </div>
          ...
          <FadeUp delay={0.1}>
            <div className="max-w-3xl mx-auto">
              <div className="p-8 md:p-12 border border-[#D69E2E]/25 bg-white/3 text-center mb-8">
                <div className="font-display text-xl md:text-3xl text-white mb-2 leading-loose">
                  ...
                  <span className="inline-block mx-4 text-center">
                    <span className="block border-b border-white/40 pb-2 px-4 mb-2">
                      <span className="text-[#D69E2E]">Asset(C)</span>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  { var: "C (Cash)", label: lang === "ko" ? "현재 자산 + 연금" : "Current Assets + Pension", color: "#D69E2E" },
        ...
        <div className="container">
          <FadeUp>
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.stageLabel}</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A4731] leading-tight mb-4">
                {t.stageTitle}
              </h2>
              ...
              <button
                ...
                className={`px-5 py-2.5 text-sm font-medium transition-all duration-300 ${
                  activeStage === i
                    ...
                    : "border border-[#D1CBC0] text-[#6B7280] hover:border-[#1A4731] hover:text-[#1A4731]"
                }`}
              >
                <span className="font-accent italic mr-2" style={{ color: activeStage === i ? "#D69E2E" : stages[i].color }}>
                  {stage.num}
                </span>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <FadeUp key={activeStage}>
              <div>
                ...
                <h3 className="font-display text-3xl font-bold text-[#1A4731] mb-1">
                ...
                {stages[activeStage].formula && (
                  <div className="mt-8 p-5 bg-[#1A4731]">
                    <p className="font-display text-[#D69E2E] text-sm font-semibold mb-2">
            ...
            <FadeUp delay={0.15}>
              <div className="relative overflow-hidden aspect-[4/3]">
                ...
                {activeStage === 2 && (
                  <div className="w-full h-full bg-[#1A4731] flex flex-col items-center justify-center p-8 text-center">
                ...
                {activeStage === 3 && (
                  <div className="w-full h-full bg-[#1A4731] flex flex-col items-center justify-center p-8 text-center">
                    <Star size={48} className="text-[#D69E2E] mb-4" />
                    <p className="font-display text-white text-xl font-bold mb-2">
                      {lang === "ko" ? "죽음은 끝이 아닙니다" : "Death is not the end"}
                    </p>
                    <p className="font-body text-white/45 text-sm">
                      {lang === "ko" ? "별이 되는 과정,\n2막1장이 품격 있게 함께합니다." : "The process of becoming a star,\nImakiljang walks with you with dignity."}
                    </p>
                  </div>
                )}
              </div>
      ...
      {/* ── PERSONA ──────────────────────────────────────────────────────── */}
      <section className="py-24 md:py-32 bg-[#1A4731]">
        <div className="container">
          <FadeUp>
            <div className="mb-14 text-center">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.personaLabel}</span>
                <div className="w-6 h-px bg-[#D69E2E]" />
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">
                {t.personaTitle}<br />
                <span className="text-[#D69E2E]">{t.personaTitleAccent}</span>
              </h2>
            </div>
          </FadeUp>
          ...
          <div className="max-w-4xl mx-auto">
            <FadeUp delay={0.1}>
              <div className="grid md:grid-cols-2 gap-0 overflow-hidden border border-white/10">
                ...
                <div className="bg-[#1A4731] p-8 md:p-10">
                  <div className="flex items-start gap-4 mb-8">
                    <div className="w-14 h-14 bg-[#D69E2E]/20 flex items-center justify-center flex-shrink-0">
                      <span className="font-display text-[#D69E2E] text-xl font-bold">강</span>
                    </div>
                    <div>
                ...
                <div className="bg-white p-8 md:p-10">
                  <p className="font-display text-[#1A4731] text-lg font-bold mb-6">{t.personaPainTitle}</p>
        ...
        <div className="container">
          <FadeUp>
            <div className="mb-14">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.bizLabel}</span>
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A4731] leading-tight mb-4">
                {t.bizTitle}<br />
                <span className="text-[#D69E2E]">{t.bizTitleAccent}</span>
              </h2>
              ...
              return (
                <FadeUp key={i} delay={i * 0.08}>
                  <div className={`p-6 md:p-8 h-full ${i < 3 ? "border-b md:border-b-0 md:border-r border-[#E5E0D8]" : ""} group hover:bg-white transition-colors duration-300`}>
                    ...
                    <p className="font-display text-[#1A4731] font-semibold mb-2">
            ...
            <FadeUp>
              <div className="relative overflow-hidden aspect-[4/3]">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1A4731]/60 to-transparent" />
              </div>
            </FadeUp>
            <FadeUp delay={0.15}>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.communityLabel}</span>
              </div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-white leading-tight mb-6">
                {t.communityTitle}<br />
                <span className="text-[#D69E2E]">{t.communityTitleAccent}</span>
              </h2>
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex items-start gap-4">
                      <div className="w-9 h-9 bg-[#D69E2E]/15 flex items-center justify-center flex-shrink-0">
                        <Icon size={16} className="text-[#D69E2E]" />
                      </div>
                      <div>
          ...
          <FadeUp>
            <div className="max-w-2xl mx-auto text-center">
              <div className="flex items-center justify-center gap-3 mb-6">
                <div className="w-6 h-px bg-[#D69E2E]" />
                <span className="font-accent italic text-[#D69E2E] text-sm tracking-widest uppercase">{t.ctaLabel}</span>
                <div className="w-6 h-px bg-[#D69E2E]" />
              </div>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-[#1A4731] leading-tight mb-6">
                {t.ctaTitle}<br />
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Link
                  href="/#contact"
                  className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#2D6A4F] text-white text-sm font-semibold hover:bg-[#1A4731] transition-all duration-300"
                >
                  {t.ctaBtn1}
                  <ArrowRight size={14} />
                </Link>
                <Link
                  href="/"
                  className="inline-flex items-center gap-2 px-8 py-3.5 border border-[#1A4731] text-[#1A4731] text-sm font-medium hover:bg-[#1A4731] hover:text-white transition-all duration-300"
                >
                  {t.ctaBtn2}
                </Link>
              </div>
